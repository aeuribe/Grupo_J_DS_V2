...
public class GetHistorial_ConexionByIdCommand extends Command<Historial_Conexion>
{
    ...
    private long _id_HistoricalConnexion;
    private Historial_Conexion _result;
    private Historial_ConexionDao _dao;

    public GetHistorial_ConexionByIdCommand( DBHandler handler, long id_HistoricalConnexion )
    {
        //region Instrumentation DEBUG
        _logger.debug( String.format( "Get in GetHistorial_ConexionByIdCommand.ctor: parameter {%s}", _id_HistoricalConnexion) );
        //endregion

        _id_HistoricalConnexion = id_HistoricalConnexion;
        setHandler(handler);
        _dao = DaoFactory.createHistorial_ConexionDao(getHandler());

        //region Instrumentation DEBUG
        _logger.debug( String.format( "Leaving GetHistorial_ConexionByIdCommand.ctor: attribute {%s}", id_HistoricalConnexion ) );
        //endregion
    }
    ...
    public void execute()
    {
        ...
        //endregion
        _result = _dao.find(_id_HistoricalConnexion, Historial_Conexion.class);
        //region Instrumentation DEBUG
